...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div style=" height: 1600px;">
        <div  style="border: 2px solid white; position: absolute; width: 296px; height: 514px; top: 20%; left: 2%;">
            ...
            <asp:Button Style="position: absolute; top: 413px; left: 113px; height: 28px; width: 68px;" ID="Button3" runat="server" Text="Iniciar" />    
            <asp:DropDownList ID="DropDownList1" Style="position: absolute; top: 371px; left: 48px;" runat="server">
        ...
        <asp:UpdatePanel ID="UpdatePanel2" runat="server" style="float: left; ">
                ...
                <asp:Label ID="Label3" runat="server" Style = "position: center; top: 20px; left: 30px; height: 20px;" Text="Jugador 1: " ForeColor="White"></asp:Label>
